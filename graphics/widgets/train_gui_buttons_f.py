...
class TrainGuiButtonsF(tk.Frame):
    """ Train GUI buttons."""
    ...
    def _load_icons(self):
        ...
        self._img_existent_sess = utils.load_and_resize_image(
            const.TGB_EXISTENT_SESS_IMG_PATH,
            const.TGB_IMG_WIDTH,
            const.TGB_IMG_HEIGHT
        )
        self._img_new_sess = utils.load_and_resize_image(
            const.TGB_NEW_SESS_IMG_PATH,
            const.TGB_IMG_WIDTH,
            const.TGB_IMG_HEIGHT
        )
    ...
    def _create_frames(self):
        ...
        self._f_new_sess = tk.Frame(
            self._f_buttons,
            padx=const.TGB_BTN_FRAME_PADX,
            pady=const.TGB_BTN_FRAME_PADY
        )
    ...
    def _create_buttons(self):
        ...
        self._btn_new_sess = tk.Button(
            ...
            text=const.TGB_NEW_SESS_BTN,
            padx=const.TGB_BTN_PADX,
            pady=const.TGB_BTN_PADY,
        ...
        self._btn_existent_sess = tk.Button(
            ...
            text=const.TGB_EXISTENT_SESS_BTN,
            padx=const.TGB_BTN_PADX,
            pady=const.TGB_BTN_PADY,
